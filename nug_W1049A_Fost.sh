...
#SBATCH --job-name=W1049A_FOST_MCNUGGETS
#SBATCH --output=W_F_SLAB_NUG.o%j
#SBATCH --error=W_F_SLAB_NUG.e%j
...
${UD_MPIRUN} python "/home/3940/brewster_global/brewster/mcnuggets_W1049A_Fost.py" > ../log_files/W1049A_FSlab_nug.log
