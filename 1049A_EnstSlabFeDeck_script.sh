...
#mkdir -p $TMPDIR
${UD_MPIRUN} python "/home/3941/brewster_global/brewster/WISE1049A_EnstSlabFeDeck_pf7.py" > /home/3941/brewster_global/brewster/log_files/WISE1049A_EnstSlabFeDeck_pf7.log
#rm -r *core.*
mpi_rc=$?
