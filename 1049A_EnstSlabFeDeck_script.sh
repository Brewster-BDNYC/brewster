...
#mkdir -p $TMPDIR
${UD_MPIRUN} python "/home/3940/brewster_global/brewster_v1.1/brewster/WISE1049A_EnstSlabFeDeck_pf7.py" > /home/3940/brewster_global/brewster_v1.1/log_files/WISE1049A_EnstSlabFeDeck_pf7.log
#rm -r *core.*
mpi_rc=$?
