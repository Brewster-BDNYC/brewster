...
#SBATCH --job-name=WISE1049A_EnstSlabFeDeck_pf7_829
#SBATCH --output=WISE1049A_EnstSlabFeDeck_pf7_829_check.o%j
#SBATCH --error=WISE1049A_EnstSlabFeDeck_pf7_829_check.e%j
...
#mkdir -p $TMPDIR
${UD_MPIRUN} python "/home/3940/brewster_global/brewster/WISE1049A_EnstSlabFeDeck_pf7.py" > /home/3940/brewster_global/log_files/WISE1049A_EnstSlabFeDeck_pf7.log
#rm -r *core.*
mpi_rc=$?
