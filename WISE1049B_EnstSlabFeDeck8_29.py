...
# Give the run name
runname = "WISE1049B_EnstSlabFeDeck8_29"
...
if (fresh == 0):
    ...
    p0[:,8] = r2d2 + (np.random.randn(nwalkers).reshape(nwalkers) * (0.1*r2d2))  # r2d2
    p0[:,9] = np.random.randn(nwalkers).reshape(nwalkers) * 30  # vrad
