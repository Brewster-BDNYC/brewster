...
#SBATCH --job-name=WISE1049A_NC_pf7
#SBATCH --output=WISE1049A_NC_pf7_check.o%j
#SBATCH --error=WISE1049A_NC_pf7_check.e%j
...
#mkdir -p $TMPDIR
${UD_MPIRUN} python "/home/3940/brewster_global/brewster_v1.1/brewster/WISE1049A_NC_pf7.py" > /home/3940/brewster_global/brewster_v1.1/log_files/WISE1049A_NC_pf7.log
#rm -r *core.*
mpi_rc=$?
