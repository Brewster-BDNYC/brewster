...
# Give the run name
runname = "WISE1049A_EnstFostSlabFeDeck_98"
...
if (fresh == 0):
   ...
   # ------ Cloud Parameters ------
    ...
    p0[:,26] = 1700. + (100.* np.random.randn(nwalkers).reshape(nwalkers))
    p0[:,27] = (0.1 * np.random.randn(nwalkers).reshape(nwalkers)) + 1.25
    p0[:,28] = (0.1 * np.random.randn(nwalkers).reshape(nwalkers)) - 1.2
    p0[:,29] = 1150. + (100. * np.random.randn(nwalkers).reshape(nwalkers))
    p0[:,30] = 1200. + (100. * np.random.randn(nwalkers).reshape(nwalkers))
    p0[:,31] = 1300. + (100. * np.random.randn(nwalkers).reshape(nwalkers))
