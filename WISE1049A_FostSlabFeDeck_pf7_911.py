...
if (fresh == 0):
    ...
    p0[:,0] = (0.05*np.random.randn(nwalkers).reshape(nwalkers)) - 3.4 # H2O
    p0[:,1] = (0.05*np.random.randn(nwalkers).reshape(nwalkers)) - 5.25 # CH4
    p0[:,2] = (0.05*np.random.randn(nwalkers).reshape(nwalkers)) - 3.5 # CO 
    p0[:,3] = (0.05*np.random.randn(nwalkers).reshape(nwalkers)) - 4.5 # CO2 
    p0[:,4] = (0.05*np.random.randn(nwalkers).reshape(nwalkers)) - 7.0 # NH3  
    p0[:,5] = (0.05*np.random.randn(nwalkers).reshape(nwalkers)) - 10.0 # FeH
    p0[:,6] = (0.05*np.random.randn(nwalkers).reshape(nwalkers)) - 5.5 # Na+K
    p0[:,7] = 0.05*np.random.randn(nwalkers).reshape(nwalkers) + 4.5  # gravity
