...
# Give the run name
runname = "WISE1049A_EnstSlabFeDeck_pf7_101"
...
if (fresh == 0):
    ...
    p0[:,0] = (0.05*np.random.randn(nwalkers).reshape(nwalkers)) - 3.75 # H2O
    p0[:,1] = (0.05*np.random.randn(nwalkers).reshape(nwalkers)) - 3.10 # CH4
    p0[:,2] = (0.05*np.random.randn(nwalkers).reshape(nwalkers)) - 3.5 # CO 
    p0[:,3] = (0.05*np.random.randn(nwalkers).reshape(nwalkers)) - 4.0 # CO2 
    p0[:,4] = (0.05*np.random.randn(nwalkers).reshape(nwalkers)) - 6.5 # NH3  
    p0[:,5] = (0.05*np.random.randn(nwalkers).reshape(nwalkers)) - 10.0 # FeH
    p0[:,6] = (0.05*np.random.randn(nwalkers).reshape(nwalkers)) - 5.5 # Na+K
    p0[:,7] = 0.05*np.random.randn(nwalkers).reshape(nwalkers) + 5.0  # gravity
   ...
   # ------ Cloud Parameters ------
    ...
    p0[:,21] = 1000. + (10.* np.random.randn(nwalkers).reshape(nwalkers))
    p0[:,22] = (0.1 * np.random.randn(nwalkers).reshape(nwalkers)) + 1.0
    p0[:,23] = (0.1 * np.random.randn(nwalkers).reshape(nwalkers)) - 2.4
    p0[:,24] = 620. + (10. * np.random.randn(nwalkers).reshape(nwalkers))
    p0[:,25] = 680. + (10. * np.random.randn(nwalkers).reshape(nwalkers))
    p0[:,26] = 715. + (10. * np.random.randn(nwalkers).reshape(nwalkers))
