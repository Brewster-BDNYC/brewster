...
#SBATCH --job-name=WISE1049B_EnstSlabFeDeck_pf7
#SBATCH --output=WISE1049B_EnstSlabFeDeck_pf7_check.o%j
#SBATCH --error=WISE1049B_EnstSlabFeDeck_pf7_check.e%j
...
#mkdir -p $TMPDIR
${UD_MPIRUN} python "/home/3941/brewster_global/brewster/WISE1049B_EnstSlabFeDeck_pf7.py" > /home/3941/brewster_global/brewster/log_files/WISE1049B_EnstSlabFeDeck_pf7.log
#rm -r *core.*
mpi_rc=$?
