...
obspec = np.asfortranarray(np.loadtxt("./WISE1049A_Data/WISE1049A_Median.txt", unpack='true'))
...
if (fresh == 0):
    ...
    p0[:,4] = (0.5*np.random.randn(nwalkers).reshape(nwalkers)) - 4.6 # NH53  
