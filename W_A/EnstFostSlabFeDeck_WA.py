...
# Give the run name
runname = "W1049_EnstFostSlabFeDeck"
...
if (fresh == 0):
   ...
   # ------ Cloud Parameters ------
    ...
    p0[:,26] = 1500. + (20.* np.random.randn(nwalkers).reshape(nwalkers))
    p0[:,27] = (0.1 * np.random.randn(nwalkers).reshape(nwalkers)) + 1.25
    p0[:,28] = (0.1 * np.random.randn(nwalkers).reshape(nwalkers)) - 1.2
    p0[:,29] = 1500. + (25. * np.random.randn(nwalkers).reshape(nwalkers))
    p0[:,30] = 1500. + (50. * np.random.randn(nwalkers).reshape(nwalkers))
    p0[:,31] = 1500. + (20. * np.random.randn(nwalkers).reshape(nwalkers))
