...
#SBATCH --job-name=W1049A_ENST_MCNUGGETS
#SBATCH --output=W_E_SLAB_NUG.o%j
#SBATCH --error=W_E_SLAB_NUG.e%j
...
${UD_MPIRUN} python "/home/3940/brewster_global/brewster/mcnuggets_W1049A_Enst.py" > ../log_files/W1049A_ESlab_nug.log
